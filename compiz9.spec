...
Version:        0.9.14.2
Release:        1
Summary:        OpenGL window and compositing manager 0.9.x.x branch
BuildArch:      x86_64
...
%description
The Compiz 9 branch newer then what Fedora packages
...
pushd %{buildroot}/usr
find . ! -type d -exec ls {} + > %{_builddir}/compiz-%{version}/files.txt
popd
...
%{python3_sitelib}/ccm/__pycache__/
