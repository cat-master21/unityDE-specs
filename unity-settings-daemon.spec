...
Source1:        https://raw.githubusercontent.com/cat-master21/unityDE-specs/unityx/patches/unity-settings-daemon.service
...
install -m 0644 %{SOURCE1} -t %{buildroot}%{_userunitdir}
...
%{_datadir}/man/man1/unity-settings-daemon.1.gz
